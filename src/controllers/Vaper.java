...
public class Vaper extends JLabel{
    ...
    public Vaper(String spriteSheetPath, Player p) {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e){
                //IMPLEMENT DISAPEAR MODE AND ADD POINTS
                p.incrementPoints();
                Vaper.this.setVisible(false);
                Vaper.this.isClicked = true;
            }
        });
    }
    ...
    private void moveNPC() {
        int moveDistance = 0; // Reduced move distance for smoother movement
        int x = getX();
        int y = getY();
